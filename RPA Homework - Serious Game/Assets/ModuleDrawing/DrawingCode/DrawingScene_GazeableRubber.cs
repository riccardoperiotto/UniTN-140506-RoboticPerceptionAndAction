...
public class DrawingScene_GazeableRubber : MonoBehaviour, IGazeableObject
{
    ...
    {
        if (gameManager.IsEyeTrackingActive) DrawingScene_ToolSelection.SetColor(transform, Color.white);
    }
