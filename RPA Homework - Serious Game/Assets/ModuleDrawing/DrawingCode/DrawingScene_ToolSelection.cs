...
public class DrawingScene_ToolSelection : MonoBehaviour
{
    ...
    static public void InitializePalette()
    {
        ...
        foreach (Transform color in GameObject.Find("Colors").transform)
        {
            if (i == 0)
            {
                ...
                DrawingScene_Drawing.drawable.SetColor(colorsPalette[0]);
            }
    ...
    static public void SetColor(Transform transform, Color color)
    {
        ...
        DrawingScene_Drawing.drawable.SetColor(color);
        DrawingScene_WidthSelection.ColorWidthSelectors();
    }
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            if (hit.collider != null)
            {
                ...
                {
                    SetColor(hit.collider.transform, hit.collider.GetComponent<DrawingScene_GazeableColor>().color);
                }
