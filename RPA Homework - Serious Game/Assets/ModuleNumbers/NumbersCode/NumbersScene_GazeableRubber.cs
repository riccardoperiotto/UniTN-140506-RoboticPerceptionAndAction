...
public class NumbersScene_GazeableRubber : MonoBehaviour, IGazeableObject
{
    ...
    {
        if (gameManager.IsEyeTrackingActive) NumbersScene_ToolSelection.SetColor(transform, Color.white);
    }
