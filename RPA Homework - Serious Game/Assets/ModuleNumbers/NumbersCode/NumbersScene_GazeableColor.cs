...
public class NumbersScene_GazeableColor : MonoBehaviour, IGazeableObject
{
    ...
    {
        if (gameManager.IsEyeTrackingActive) NumbersScene_ToolSelection.SetColor(transform, color);
    }
